          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[0.92rem] font-semibold leading-snug text-text">{withIcons(t.message)}</p>
                {t.description && (
                  <p className="mt-0.5 text-[0.82rem] leading-snug text-muted">{withIcons(t.description)}</p>
                )}
              </div>
              <button
                type="button"
